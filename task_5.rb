# Вы завершите работу над классом PaginationHelper, который представляет собой служебный класс, полезный для запроса информации о подкачке, связанной с массивом.
